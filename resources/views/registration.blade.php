...
<div class="wrapper">
  <div id="formContent">
    ...
    <form action="/users" method="POST">
      @csrf
      <input type="text" name="name" placeholder="Ime i prezime" value={{old('name');}}> 
        @error('name')
        <p style="color:red;">{{$message}}</p> 
        @enderror
      <input type="text" name="email"  placeholder="Korisnicko ime" value={{old('email');}}>
        @error('email')
        <p style="color:red;">{{$message}}</p> 
        @enderror
      <input type="password" name="password" placeholder="Lozinka">
        @error('password')
          <p style="color:red;">{{$message}}</p> 
        @enderror
      <input type="password" name="password_confirmation"  placeholder="Ponovljena lozinka">
